    ...
    return (
        <section id='home' className={`${theme === 'dark' && "bg-grey-900"} relative min-h-screen w-full mx-auto overflow-hidden`}>
            ...
            <div className="py-16 lg:py-48 flex flex-col-reverse lg:flex-row justify-around gap-10 lg:gap-0">
                ...
                <div className="relative mx-0 mt-12 flex items-center justify-center">
                    {/* Main Avatar Image in Center */}
                    ...
                    >
                        <div className="relative w-full h-full">
                            {/* Tech Stack Image 1 - Top */}
                            <div className="absolute top-[-100px] left-1/2 transform -translate-x-1/2">
                                <div className="w-16 h-16 md:w-20 md:h-20 bg-white dark:bg-grey-800 rounded-full place-items-center flex items-center justify-center hover:shadow-lg transition-shadow">
                                    <Image alt='tech-stack' className="h-8 w-8 md:h-10 md:w-10 object-cover" src={techStackImages[0]} width={100} height={100} />
                                </div>
                            </div>

                            {/* Tech Stack Image 2 - Right */}
                            <div className="absolute top-1/2 right-[-100px] transform -translate-y-1/2">
                                <div className="w-16 h-16 md:w-20 md:h-20 bg-white dark:bg-grey-800 rounded-full place-items-center flex items-center justify-center hover:shadow-lg transition-shadow">
                                    <Image alt='tech-stack' className="h-8 w-8 md:h-10 md:w-10 object-cover" src={techStackImages[1]} width={100} height={100} />
                                </div>
                            </div>

                            {/* Tech Stack Image 3 - Bottom */}
                            <div className="absolute bottom-[-100px] left-1/2 transform -translate-x-1/2">
                                <div className="w-16 h-16 md:w-20 md:h-20 bg-white dark:bg-grey-800 rounded-full place-items-center flex items-center justify-center hover:shadow-lg transition-shadow">
                                    <Image alt='tech-stack' className="h-8 w-8 md:h-10 md:w-10 object-cover" src={techStackImages[2]} width={100} height={100} />
                                </div>
                            </div>

                            {/* Tech Stack Image 4 - Left */}
                            <div className="absolute top-1/2 left-[-100px] transform -translate-y-1/2">
                                <div className="w-16 h-16 md:w-20 md:h-20 bg-white dark:bg-grey-800 rounded-full place-items-center flex items-center justify-center hover:shadow-lg transition-shadow">
                                    <Image alt='tech-stack' className="h-8 w-8 md:h-10 md:w-10 object-cover" src={techStackImages[3]} width={100} height={100} />
                                </div>
                            </div>
                        </div>
                    </motion.div>
