...
export function Hero({ profile, socials }: HeroProps) {
  const { name, hero_headline, hero_subtitle, short_desc, titles, hero_stats, availability, availability_label } = profile
  ...
  return (
    <section id="home" className="relative min-h-screen w-full bg-background">
      ...
      <div className="mx-auto flex min-h-screen max-w-5xl flex-col justify-center px-6 py-24 lg:px-8">

        {/* Availability badge — above headline */}
